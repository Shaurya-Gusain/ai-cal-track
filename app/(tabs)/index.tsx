...
export default function HomeScreen() {
  ...
  const [savedTreks, setSavedTreks] = useState<string[]>([]);
      ...
      >
        {TREK_DATA.map((trek) => (
          <TouchableOpacity
            ...
            onPress={() => router.push('/trek/' + trek.id as any)}
            activeOpacity={0.9}
          >
            <View style={styles.imageContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => toggleSave(trek.id)}
              >
                <Ionicons
                  name={savedTreks.includes(trek.id) ? 'bookmark' : 'bookmark-outline'}
                  size={22}
                  color={savedTreks.includes(trek.id) ? '#2E7D32' : '#FFFFFF'}
                />
              </TouchableOpacity>
            </View>
